...
TICKET_FORM_FIELDS = {
    "onboarding": [
        ...
        {"key": "application_requested", "label": "Application Requested", "type": "text", "required": False},
...
WORKFLOW_DEFINITIONS = {
    "onboarding": {
        ...
        "states": [
            ...
            {"name": "CREATE CREDENTIALS", "color": "#e0e7ff", "text_color": "#4338ca", "is_initial": False, "is_terminal": False, "order": 2},
            ...
            {"name": "NOT APPROVED", "color": "#fecaca", "text_color": "#7f1d1d", "is_initial": False, "is_terminal": True, "order": 5},
            {"name": "HOLD", "color": "#fed7aa", "text_color": "#9a3412", "is_initial": False, "is_terminal": False, "order": 6},
        ],
        "transitions": [
            {"from_state": "WAITING FOR SUPPORT", "to_state": "ACKNOWLEDGE"},
            {"from_state": "WAITING FOR SUPPORT", "to_state": "IN PROGRESS"},
            {"from_state": "ACKNOWLEDGE", "to_state": "IN PROGRESS"},
            {"from_state": "ACKNOWLEDGE", "to_state": "WAITING FOR SUPPORT"},
            {"from_state": "IN PROGRESS", "to_state": "CREATE CREDENTIALS"},
            {"from_state": "IN PROGRESS", "to_state": "RESOLVED"},
            {"from_state": "IN PROGRESS", "to_state": "NOT APPROVED"},
            {"from_state": "IN PROGRESS", "to_state": "HOLD"},
            {"from_state": "CREATE CREDENTIALS", "to_state": "IN PROGRESS"},
            {"from_state": "HOLD", "to_state": "IN PROGRESS"},
            {"from_state": "*", "to_state": "ACKNOWLEDGE"},
        ],
    },
    "offboarding": {
        ...
        "states": [
            ...
            {"name": "RESOLVED", "color": "#bbf7d0", "text_color": "#14532d", "is_initial": False, "is_terminal": True, "order": 3},
