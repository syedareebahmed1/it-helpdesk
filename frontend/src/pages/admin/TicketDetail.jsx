...
const FIELD_LABELS = {
  ...
  request_type: "Request Type", access_type: "Access Type", commando_role: "Commando Role", superset_role: "Burraq Access Module (Role)", google_request_type: "Google Workspace Request", platform_client: "Platform Client", platform_role: "Platform Role / Scope", scope_action: "Action", justification: "Justification",
